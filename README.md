...
>
> 🧭 **In review:** a proposed redesign keeps these four labs as *Level 1* of a six-level path that follows an Azure environment's operational lifecycle — deploy, monitor, secure, protect, detect, recover. It is a curriculum outline only and changes nothing above: **[Curriculum Redesign](../../wiki/Curriculum-Redesign)**.
